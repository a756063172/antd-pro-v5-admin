...
import { history, RequestConfig, RunTimeLayoutConfig, fixContext, AliveScope } from 'umi';
...
const PageWrapper = ({ children, routes }: { children: any, routes: any }) => {
  return (
    <AliveScope >
...
export function rootContainer(container: HTMLElement) {
  return React.createElement(PageWrapper, null, container);
}
